...
export function KPITile({ data }: { data?: TileData }) {
  ...
  return (
    <div className="group relative rounded-2xl border border-zinc-800/60 bg-gradient-to-br from-zinc-950/60 to-zinc-900/40 p-5 shadow-sm transition-all hover:border-zinc-700/80 hover:shadow-xl hover:shadow-zinc-900/20">
      ...
      <div className="relative flex items-start justify-between gap-3">
        ...
        <button
          onClick={() => setOpen((v) => !v)}
          className={`shrink-0 rounded-xl border bg-zinc-950 px-3 py-2 text-xs transition-colors hover:bg-zinc-900 ${badge.cls}`}
      ...
      {open && (
        <div className="relative mt-4 rounded-xl border border-zinc-800/60 bg-zinc-950 p-4 text-sm">
