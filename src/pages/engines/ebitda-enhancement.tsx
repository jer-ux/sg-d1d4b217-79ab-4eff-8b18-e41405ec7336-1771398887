...
export default function EBITDAEnhancementPage() {
  return (
    <>
      <Head>
        <title>EBITDA Enhancement Engine | Kincaid Health</title>
        <meta
          name="description"
          content="Enterprise value optimization through healthcare cost reduction. PE-grade financial modeling for EBITDA impact quantification."
        />
      </Head>
        ...
        <main className="container mx-auto px-4 py-8 relative z-10">
          ...
          >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                { value: "$4.2M", label: "Avg Value Creation", color: "green" },
                { value: "6-9x", label: "EBITDA Multiple", color: "emerald" },
                { value: "18mo", label: "Implementation", color: "teal" },
                { value: "Board-Ready", label: "Reporting", color: "lime" }
              ].map((metric, idx) => (
                <motion.div
                  key={idx}
                  initial={{ opacity: 0, y: 20 }}
