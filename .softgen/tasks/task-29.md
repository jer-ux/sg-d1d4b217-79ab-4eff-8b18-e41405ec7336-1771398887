...
## Checklist:
- [x] Catalog all remaining user PDF uploads in the asset array inside `all-uploads.tsx`.
- [x] Implement browser-native iframe page 1 rendering (`#page=1&toolbar=0&navpanes=0&scrollbar=0`) with interactive click-to-expand overlays.
- [x] Run a project check to verify the build is clean and flawless.