...
created_by: agent
created_at: 2026-06-13T06:28:00Z
position: 1
---

## Notes:
Deliver an outstanding, highly interactive "Fiduciary Lab Hub" featuring all three high-value tools built as separate, pristine, modular React components to keep files under the 300-line limit:
1. **LandingUploader**: Drag-and-drop secure PBM contract uploader with real-time audit scan simulation, forensic error flag overlay, and call-to-actions.
2. **LandingBrokerLookup**: Instant search directory for benefits brokerage firms showing transparency compliance grades, hidden commission skims, and regulatory risk ratings.
