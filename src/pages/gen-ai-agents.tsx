  ...
  return (
    <>
      <SEO
        ...
        description="Deploy AI agents with enterprise-grade controls, evidence lineage, and CFO-grade accountability. No theater, just verified outcomes."
      />
