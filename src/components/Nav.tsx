      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="hidden md:flex md:items-center md:space-x-1">
            ...
            {/* Solutions Menu - NOW CLICK-BASED */}
            <div className="relative">
              <button
              ...
              {solutionsDropdownOpen && (
                <div className="absolute top-full left-0 mt-2 w-72 bg-gray-900/95 backdrop-blur-xl rounded-xl border border-gray-700/50 shadow-xl overflow-hidden max-h-[80vh] overflow-y-auto z-[210]">
                  <div className="p-2">
