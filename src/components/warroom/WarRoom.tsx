    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      <header className="border-b border-zinc-800/60 bg-zinc-950/80">
        <div className="mx-auto max-w-7xl px-6 py-5">
          <div className="flex items-start justify-between gap-4">
            <div>
              <div className="text-xs tracking-wide text-zinc-400">Kincaid Health</div>
      ...
      <main className="mx-auto max-w-7xl px-6 py-6">
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          <KPITile data={tileMap.get("cashflow")} />
          <KPITile data={tileMap.get("recoverableEbitda")} />
          <KPITile data={tileMap.get("healthIQ")} />
          <KPITile data={tileMap.get("execution")} />
        </div>
        ...
        <div className="mt-6 rounded-2xl border border-zinc-800/60 bg-zinc-950/60 p-5">
          ...
          <div className="mt-2 text-sm text-zinc-200">
            Detect → Prove → Act → Realize. This War Room is designed to run weekly exec rhythm and board updates with
