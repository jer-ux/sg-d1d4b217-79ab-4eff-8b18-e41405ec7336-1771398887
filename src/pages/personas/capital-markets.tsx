      ...
      <div className="min-h-screen bg-gradient-to-b from-indigo-950 via-slate-950 to-black text-white">
        ...
        <section className="py-24 px-4">
          <div className="max-w-4xl mx-auto">
            <Card className="relative bg-gradient-to-br from-indigo-900/80 to-blue-900/80 border-4 border-indigo-400 p-12 shadow-[0_0_60px_rgba(99,102,241,0.6),0_0_100px_rgba(99,102,241,0.4),0_0_140px_rgba(99,102,241,0.2)] animate-pulse">
              <div className="absolute inset-0 bg-gradient-to-r from-indigo-500/20 via-blue-500/20 to-cyan-500/20 animate-pulse rounded-lg" />
              <div className="absolute -inset-1 bg-gradient-to-r from-indigo-600 via-blue-600 to-cyan-600 rounded-lg blur-xl opacity-75 animate-pulse" />
              
              <div className="relative">
                <div className="text-center mb-8">
                  <div className="inline-block px-6 py-2 bg-gradient-to-r from-indigo-500 to-blue-500 rounded-full mb-4 shadow-[0_0_30px_rgba(99,102,241,0.8)] animate-pulse">
                ...
                <form className="max-w-2xl mx-auto space-y-6">
                  ...
                  <Button
                    type="submit"
                    size="lg"
                    className="w-full bg-gradient-to-r from-indigo-500 via-blue-500 to-cyan-500 hover:from-indigo-400 hover:via-blue-400 hover:to-cyan-400 text-white text-2xl font-black py-8 shadow-[0_0_40px_rgba(99,102,241,0.9),0_0_60px_rgba(99,102,241,0.6),0_0_80px_rgba(99,102,241,0.4)] hover:shadow-[0_0_50px_rgba(99,102,241,1),0_0_80px_rgba(99,102,241,0.8),0_0_120px_rgba(99,102,241,0.6)] animate-pulse uppercase tracking-wider border-2 border-white/50"
                  >
