  ...
  return (
    <>
      <SEO
        ...
        description="Meet the leadership team guiding SiriusB iQ's mission to revolutionize health economics and benefits intelligence through algorithmic fiduciary platforms."
      />
      <Nav />
