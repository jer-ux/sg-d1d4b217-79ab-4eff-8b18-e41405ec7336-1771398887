                  ...
                  <div className="grid md:grid-cols-2 gap-6 mt-6">
                      ...
                      <div className="space-y-4">
                        <div>
                          <div className="flex items-center justify-between mb-2">
                            <span className="text-xs text-neutral-400">Contract Compliance</span>
                        ...
                        <div>
                          <div className="flex items-center justify-between mb-2">
                            <span className="text-xs text-neutral-400">Regulatory Adherence</span>
                            <span className="text-xs font-semibold text-emerald-400">Low Risk</span>
                          </div>
                          <div className="h-2 bg-[#0F1419] rounded overflow-hidden">
                        ...
                        <div>
                          <div className="flex items-center justify-between mb-2">
                            <span className="text-xs text-neutral-400">Vendor Oversight</span>
                    ...
                    <div className="bg-[#151B23] border border-[#2A3F54] rounded-lg p-6">
                      ...
                      <div className="space-y-3">
                        <div className="bg-[#0F1419] border border-emerald-900/40 rounded p-3">
                          <div className="flex items-center justify-between mb-1">
                            <span className="text-sm text-neutral-300">PBM Contract Renegotiation</span>
                            <Badge className="bg-emerald-900/20 text-emerald-400 border-0 text-xs">On Track</Badge>
                          </div>
                          <div className="text-xs text-neutral-400">Target completion: Q1 2027</div>
                        </div>
                        <div className="bg-[#0F1419] border border-[#2A3F54] rounded p-3">
                          <div className="flex items-center justify-between mb-1">
                            <span className="text-sm text-neutral-300">Cost-Plus Migration Analysis</span>
                            <Badge className="bg-blue-900/20 text-blue-400 border-0 text-xs">In Progress</Badge>
                          </div>
                          <div className="text-xs text-neutral-400">Phase 1 of 3 complete</div>
                        </div>
                      </div>
                    </div>
                  </div>

                  <div className="bg-[#1A3A52]/10 border border-[#1A3A52] rounded-lg p-6 mt-6">
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-4 gap-4">
                    <div className="bg-[#151B23] border border-[#2A3F54] rounded-lg p-5">
                      ...
                      <div className="text-xs text-emerald-400 mt-1">Across 3 portcos</div>
                    </div>
                    <div className="bg-[#151B23] border border-[#2A3F54] rounded-lg p-5">
