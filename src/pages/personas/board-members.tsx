      ...
      <div className="min-h-screen bg-gradient-to-b from-purple-950 via-slate-950 to-black text-white">
        ...
        <section className="py-24 px-4">
          <div className="max-w-4xl mx-auto">
            <Card className="relative bg-gradient-to-br from-purple-900/80 to-violet-900/80 border-4 border-purple-400 p-12 shadow-[0_0_60px_rgba(168,85,247,0.6),0_0_100px_rgba(168,85,247,0.4),0_0_140px_rgba(168,85,247,0.2)] animate-pulse">
              <div className="absolute inset-0 bg-gradient-to-r from-purple-500/20 via-violet-500/20 to-fuchsia-500/20 animate-pulse rounded-lg" />
              <div className="absolute -inset-1 bg-gradient-to-r from-purple-600 via-violet-600 to-fuchsia-600 rounded-lg blur-xl opacity-75 animate-pulse" />
              
              <div className="relative">
                <div className="text-center mb-8">
                  <div className="inline-block px-6 py-2 bg-gradient-to-r from-purple-500 to-violet-500 rounded-full mb-4 shadow-[0_0_30px_rgba(168,85,247,0.8)] animate-pulse">
                    <span className="text-sm font-black text-white uppercase tracking-wider">🎰 Exclusive Board Package 🎰</span>
                  </div>
                ...
                <form className="max-w-2xl mx-auto space-y-6">
                  ...
                  <Button
                    type="submit"
                    size="lg"
                    className="w-full bg-gradient-to-r from-purple-500 via-violet-500 to-fuchsia-500 hover:from-purple-400 hover:via-violet-400 hover:to-fuchsia-400 text-white text-2xl font-black py-8 shadow-[0_0_40px_rgba(168,85,247,0.9),0_0_60px_rgba(168,85,247,0.6),0_0_80px_rgba(168,85,247,0.4)] hover:shadow-[0_0_50px_rgba(168,85,247,1),0_0_80px_rgba(168,85,247,0.8),0_0_120px_rgba(168,85,247,0.6)] animate-pulse uppercase tracking-wider border-2 border-white/50"
                  >
